...
const CustomAdvertisementPage = () => {
  ...
  return (
    <>
      <Column className="bg-gray_53 font-gilroy items-center mx-[auto] w-[100%]">
        ...
        <Row className="items-center justify-evenly w-[97%]">
          <aside className="w-[25%]">
            <Column className="">
              <Column className="bg-white_A700 justify-end lg:p-[17px] xl:p-[19px] 2xl:p-[22px] 3xl:p-[26px] w-[86%]">
                ...
                <Row className="ml-[2px] mr-[auto] lg:mt-[33px] xl:mt-[38px] 2xl:mt-[43px] 3xl:mt-[51px] py-[1px] w-[58%]">
                  <Line className="bg-blue_A700 lg:h-[19px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] w-[2px]" />
                  <Img
                    src="images/img_vector_blue_A701_20X18.svg"
                    className="lg:h-[16px] xl:h-[18px] 2xl:h-[21px] 3xl:h-[25px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] mt-[2px] w-[12%]"
                    alt="Vector One"
                  />
                  <Text className="font-semibold 2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[8px] xl:ml-[9px] mt-[3px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-blue_A700 w-[auto]">
                    Advertisement{" "}
                  </Text>
                </Row>
          ...
          <Column className="w-[75%]">
            <Row className="items-center w-[100%]">
              ...
              <Text className="font-semibold lg:ml-[521px] xl:ml-[596px] 2xl:ml-[671px] 3xl:ml-[805px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_902 w-[auto]">
            ...
            <Img
              ...
              className="lg:h-[270px] xl:h-[309px] 2xl:h-[348px] 3xl:h-[417px] lg:mt-[34px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] rounded-radius6 w-[100%]"
              alt="Rectangle1388"
            />
            <Row className="justify-evenly lg:mt-[34px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[100%]">
              <Column className="w-[52%]">
                ...
                <Input
                  ...
                  wrapClassName="2xl:mt-[8px] 3xl:mt-[9px] lg:mt-[6px] w-[94%] xl:mt-[7px]"
                  name="InputField One"
            ...
            <Row className="lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[85%]">
              <Column className="mt-[1px] w-[60%]">
                <Text className="font-medium lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_901 w-[auto]">
                  Select Advertisement Type
                </Text>
                <SelectBox
                  className="font-medium lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_200 w-[94%]"
                  ...
                  indicator={
                    <Img
                      ...
                      className="lg:w-[6px] lg:h-[4px] lg:mr-[13px] xl:w-[7px] xl:h-[5px] xl:mr-[15px] 2xl:w-[8px] 2xl:h-[6px] 2xl:mr-[17px] 3xl:w-[9px] 3xl:h-[7px] 3xl:mr-[20px]"
                      alt="arrow_down"
                    />
                  }
              ...
              <Column className="w-[40%]">
                ...
                <Row className="items-center lg:mt-[15px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] py-[2px] w-[100%]">
                  <Button
                  ...
                  <Text className="font-medium lg:ml-[12px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_801 w-[auto]">
                    Android
                  </Text>
                  <CheckBox
                    className="font-medium lg:ml-[38px] xl:ml-[44px] 2xl:ml-[50px] 3xl:ml-[60px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_801"
                    inputClassName="h-[23.75px] mr-[5px] w-[23.75px]"
                    name="InputPlaceho One"
                    label="iOS"
                  ></CheckBox>
                  <CheckBox
                    className="font-medium lg:ml-[38px] xl:ml-[44px] 2xl:ml-[50px] 3xl:ml-[60px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_801"
                    inputClassName="h-[23.75px] mr-[5px] w-[23.75px]"
                    name="InputPlaceho Two"
                    label="Web"
                  ></CheckBox>
                </Row>
              </Column>
            </Row>
            <Row className="justify-evenly lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[100%]">
              <Column className="w-[52%]">
                <Text className="font-medium lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_901 w-[auto]">
                  Start Date
                </Text>
                <Input
                  className="font-medium p-[0] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] placeholder:text-bluegray_200 text-bluegray_200 w-[100%]"
                  wrapClassName="2xl:mt-[8px] 3xl:mt-[9px] flex lg:mt-[6px] w-[94%] xl:mt-[7px]"
            ...
            <Row className="items-center justify-between lg:mt-[34px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] w-[100%]">
              <Button
                className="font-medium lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[48%]"
                size="lg"
