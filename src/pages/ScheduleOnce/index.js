      ...
      <Column className="bg-gray_53 font-gilroy mx-[auto] w-[100%]">
        ...
        <Row className="w-[49%]">
          ...
          <Column className="lg:mt-[30px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] w-[53%]">
            ...
            <Column className="bg-white_A700 items-center justify-end lg:mt-[24px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius8 w-[100%]">
              <Row className="items-center justify-between mt-[2px] w-[98%]">
                <Img
                  src="images/img_scheduleoncelo.png"
                  className="lg:h-[23px] xl:h-[26px] 2xl:h-[30px] 3xl:h-[35px] w-[40%]"
                  alt="scheduleoncelo"
                />
                <Switch value={true} className="w-[13%]" />
              </Row>
              <Column className="lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
...
export default ScheduleOncePage;
