...
import { Column, Row, Img, Input, Text, Radio, Button, Line } from "components";
import { CloseSVG } from "../../assets/images/index.js";

const RupayIntegrationPage = () => {
      ...
      <Column className="bg-gray_50 font-gilroy items-center justify-end mx-[auto] w-[100%]">
        ...
        <Row className="lg:mt-[54px] xl:mt-[62px] 2xl:mt-[70px] 3xl:mt-[84px] w-[88%]">
          <Column className="bg-white_A700 items-center lg:p-[15px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] rounded-radius8 shadow-bs1 w-[67%]">
            ...
            ></Input>
            <Column className="bg-white_A700 border border-bluegray_100 border-solid lg:mt-[17px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius4 w-[97%]">
              <Radio
                value="CreditDebitATMCard"
                className="font-medium lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-black_902"
                inputClassName="h-[24px] mr-[5px] w-[24px]"
                checked={true}
                name="InputPlaceho"
                label="CreditDebitATM Card"
              ></Radio>
              <Column className="lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] lg:mr-[150px] xl:mr-[172px] 2xl:mr-[194px] 3xl:mr-[232px] lg:mt-[27px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[66%]">
                <Text className="font-medium lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_902 w-[auto]">
                  Name On Card
                </Text>
                <Input
                ...
                ></Input>
                <Text className="font-medium lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_902 w-[auto]">
                  Card Number
                </Text>
                <Row className="bg-white_A700 border border-bluegray_100 border-solid items-center justify-between xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] rounded-radius4 w-[100%]">
                ...
                <Row className="justify-between lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[100%]">
            ...
            <Row className="bg-white_A700 border border-bluegray_100 border-solid items-center justify-end lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius4 w-[97%]">
              <div className="border border-bluegray_100 border-solid lg:h-[19px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] rounded-radius50 lg:w-[18px] xl:w-[21px] 2xl:w-[24px] 3xl:w-[28px]"></div>
              <Img
                ...
                alt="computer"
              />
              <Text className="font-medium lg:ml-[16px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] 2xl:my-[11px] 3xl:my-[13px] lg:my-[8px] xl:my-[9px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-black_901 w-[auto]">
                Net Banking
              </Text>
            </Row>
            <Row className="bg-white_A700 border border-bluegray_100 border-solid items-center justify-end 2xl:mb-[11px] 3xl:mb-[13px] lg:mb-[8px] xl:mb-[9px] lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius4 w-[97%]">
              <div className="border border-bluegray_100 border-solid lg:h-[19px] xl:h-[22px] 2xl:h-[25px] 3xl:h-[29px] rounded-radius50 lg:w-[18px] xl:w-[21px] 2xl:w-[24px] 3xl:w-[28px]"></div>
              <Img
                src="images/img_offer_5.svg"
                className="lg:h-[23px] xl:h-[26px] 2xl:h-[30px] 3xl:h-[35px] lg:ml-[21px] xl:ml-[24px] 2xl:ml-[28px] 3xl:ml-[33px] 2xl:my-[11px] 3xl:my-[13px] lg:my-[8px] xl:my-[9px] w-[4%]"
                alt="offer"
              />
              <Text className="font-medium lg:ml-[16px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] 2xl:my-[11px] 3xl:my-[13px] lg:my-[8px] xl:my-[9px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-black_901 w-[auto]">
                Cash on Delivery
...
export default RupayIntegrationPage;
